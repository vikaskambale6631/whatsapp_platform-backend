#!/usr/bin/env python3
"""
Script to initialize all tables in the new PostgreSQL database using direct URL
"""
...
def main():
    ...
    logger.info(f"🔗 Database: {DATABASE_URL.split('@')[1].split('/')[0]}")  # Show host without credentials
